...
class PaymentStepDefinitions {
    ...
    private var paymentResponse: ApiResponse<PaymentDto>? = null
    private var transactionResponse: ApiResponse<List<TransactionDto>>? = null
    ...
    fun theTransactionShouldAppearInTheHistory() {
        runBlocking {
            val response = mockApiService.getTransactionHistory()
            assertTrue(response.success)
            assertTrue(response.data?.isNotEmpty() == true)
        }
    }
    ...
    fun theTransactionShouldAppearInTheHistoryWithCurrency(expectedCurrency: String) {
        runBlocking {
            ...
            assertTrue(response.data?.all { it.currency.isNotEmpty() } == true)
        }
    }
    ...
    fun iShouldReceiveAListOfTransactions() {
        ...
        assertTrue(transactionResponse!!.data?.isNotEmpty() == true)
    }
